...
import { options, search, add } from 'ionicons/icons';

import SessionList from '../../components/SessionList';
import SessionListFilter from '../../components/SessionListFilter';
import NewTaskForm from '../../pages/Caretaker/NewTaskForm';
import './SchedulePage.scss';
...
const SchedulePage: React.FC<SchedulePageProps> = ({
  ...
  const handleSaveTask = (task: { name: string; time: string; activity: string; location: string; image: string }) => {
    // Add the new task to your schedule here
    console.log('New Task:', task);
    // Logic to add the new task to the schedule goes here
  };
      ...
      <IonHeader translucent={true}>
        <IonToolbar>
          ...
          <IonButtons slot="end">
            ...
            <IonButton onClick={() => setShowNewTaskModal(true)}>
