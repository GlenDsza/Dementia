...
const mockData = [
  ...
  },
  {
    name: 'Pride Circle',
    description:
      'Bangalore’s LGBTQ+ community is active and inclusive, supported by groups like Namma Pride and Sangama. The city hosts pride events and offers various safe spaces and support networks.',
    image:
