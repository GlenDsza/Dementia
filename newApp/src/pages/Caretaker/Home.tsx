...
// //           <IonGrid fixed>
// //             <IonRow className="speaker-list-add">
              
// //               {speakers.map((speaker) => (
// //                 <IonCol size="20" size-md="7" size-lg="4" key={speaker.id}>
// //                   <SpeakerItem
// //                     key={speaker.id}
// //                     speaker={speaker}
...
// //                 <h5 style={{ paddingLeft: '14px' }}>To-Do List</h5>
...
// //           <IonHeader>
// //             <IonToolbar>
// //               <IonTitle>Add New To-Do Item</IonTitle>
// //               <IonButtons slot="end">
...
// //               <IonInput name="name" value={newTodo.name} onIonChange={handleTodoInputChange} />
// //             </IonItem>
// //             <IonItem>
// //               <IonLabel position="stacked">Time</IonLabel>
// //               <IonInput name="time" value={newTodo.time} onIonChange={handleTodoInputChange} />
// //             </IonItem>
// //             <IonItem>
// //               <IonLabel position="stacked">Activity</IonLabel>
// //               <IonInput name="activity" value={newTodo.activity} onIonChange={handleTodoInputChange} />
// //             </IonItem>
// //             <IonItem>
// //               <IonLabel position="stacked">Location</IonLabel>
// //               <IonInput name="location" value={newTodo.location} onIonChange={handleTodoInputChange} />
// //             </IonItem>
// //             <IonItem>
...
// //               <IonInput name="mapUrl" value={newTodo.mapUrl} onIonChange={handleTodoInputChange} />
// //             </IonItem>
// //             <IonButton expand="block" onClick={handleAddTodo}>Add To-Do</IonButton>
// //           </IonContent>
// //         </IonModal>
// //         {/* Embedded CSS */}
// //         <style>{`
...
//               {speakers.map((speaker) => (
//                 <IonCol className='location-card' size="11" size-md="7" size-lg="4" key={speaker.id}>
//                   <SpeakerItem 
//                     key={speaker.id}
//                     speaker={speaker}
//                     sessions={speakerSessions[speaker.name]}
...
//             <IonItem>
//               <IonLabel position="stacked">Image URL</IonLabel>
//               <IonInput name="profilePic" value={newSpeaker.profilePic} onIonChange={handleSpeakerInputChange} />
//             </IonItem>
//             <IonItem>
//               <IonLabel position="stacked">Name</IonLabel>
//               <IonInput name="name" value={newSpeaker.name} onIonChange={handleSpeakerInputChange} />
//             </IonItem>
//             <IonItem>
//               <IonLabel position="stacked">Phone</IonLabel>
//               <IonInput name="phone" value={newSpeaker.phone} onIonChange={handleSpeakerInputChange} />
//             </IonItem>
